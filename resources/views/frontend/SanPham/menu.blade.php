                                ...
                                @foreach ($SanPham as $SP)
                                    @if ($LSP->id == $SP->id_loaisanpham)
                                        <div class="pricing-entry d-flex ftco-animate">
                                             <a href="{{ route('SanPham.show', $SP->id) }}"><div class="img"
                                                style="background-image: url({{ asset('uploads/SanPham/' . $SP->hinhanh) }});">
                                            </div></a>
                                            <div class="desc pl-3">
                                                <div class="d-flex text align-items-center">
                                                    <h3><span><a
                                                                href="{{ route('SanPham.show', $SP->id) }}">{{ $SP->tensanpham }}</a></span>
                                                    </h3>
