                                        ...
                                        @if ($item->id == $itemreply->matraloi)
                                            <div class="rowuserreply">
                                                @if ($itemreply->trangthai == 2)
                                                    <img src="{{ asset('uploads/Logo/logo_sun_coffee.png') }}" alt="" style="width: 30px">
                                                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="dataxemsanpham">
                    <div class="billing-form ftco-bg-dark ftco-bg-dark-info p-3 p-md-5">
                        ...
                        <p style="margin: 7px 0px;">- Thông tin ảnh hưởng đến công việc kinh doanh của Sun Coffee.</p>
                        <p style="margin: 7px 0px;">- Những thông tin khác mà công ty chúng tôi cho rằng không hợp lý khi đăng tải lên Sun Coffee.</p>
