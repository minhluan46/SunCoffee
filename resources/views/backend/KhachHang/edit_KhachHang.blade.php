...
@section('content')
    <div class="main_content_iner ">
        <form class="add-form" method="POST" action="{{ route('khach-hang.update', $KhachHang->id) }}"
            ...
            <div class="btn-pm">
                <div class="mb-3 btn-1">
                    ...
                    <a class="btn btn-danger" href="{{ route('khach-hang.index') }}"><span class="btn-label"><i
                    ...
                    <div class="white_card">
                        <div class="white_card_header">
                            <div class="main-title">
                                <h3 class="m-0">Cập Nhật Khách Hàng</h3>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class='@error(' sdt') is-invalid @enderror form-control'
                                            id="SDT" name="sdt" required value="{{$KhachHang->sdt}}">
                                    </div>
                                    @error('sdt')
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="int" class='@error(' tenkhachhang') is-invalid @enderror form-control'
                                            maxlength="50" name="tenkhachhang" required value="{{$KhachHang->tenkhachhang}}">
                                    </div>
                                    @error('tenkhachhang')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class='@error(' diemtichluy') is-invalid @enderror
                                            form-control' name="diemtichluy" value="0" required value="{{$KhachHang->diemtichluy}}">
                                    </div>
                                    @error('diemtichluy')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class='@error(' diachi') is-invalid @enderror form-control'
                                            maxlength="150" name="diachi" required>{{$KhachHang->diachi}}</textarea>
                                    </div>
                                    @error('diachi')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
