    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class='money form-control' name="diemtichluy" required
                    value="{{ $KhachHang->diemtichluy }}">
            </div>
            <div class="form-group">
                <label>Địa Chỉ<b style="color:red"> *</b></label>
                <textarea type="text" class='form-control' maxlength="150" name="diachi"
                    required>{{ $KhachHang->diachi }}</textarea>
            </div>
            <button id="form-edit" data-url="{{ route('khach-hang.update', $KhachHang->id) }}"
                data-id="{{ $KhachHang->id }}" type="submit" class="btn btn-success" style="width: 100%">Cập Nhật</button>
        </div>
    </div>
</form>
