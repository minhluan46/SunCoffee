...
@section('content')
    <div class="main_content_iner ">
        <form class="add-form" method="POST" action="{{ route('khuyen-mai.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="btn-pm">
                    ...
                    <div class="white_card">
                        <div class="white_card_header">
                            <div class="main-title">
                                <h3 class="m-0">Thêm Khuyến Mãi</h3>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class='@error(' tenkhuyenmai') is-invalid @enderror form-control'
                                            maxlength="100" name="tenkhuyenmai">
                                    </div>
                                    @error('tenkhuyenmai')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class='@error(' thoigianbatdau') is-invalid @enderror
                                            form-control' name="thoigianbatdau">
                                    </div>
